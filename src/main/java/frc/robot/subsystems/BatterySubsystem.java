...
public class BatterySubsystem extends SubsystemBase {
  ...
  public void periodic() { // No indent = Not shown on BFG screen. One indent = Partially shown on BFG screen. Two indents = Shown on BFG screen.
    ...
    Logger.recordOutput("TankDrive/BatterySubsystem/LastMatch/StartingCharge_Wh", BFG.getMatchStartingEnergy()); // PWF Device Management page calls this "Starting depth of discharge"
    ...
    Logger.recordOutput("TankDrive/BatterySubsystem/LastMatch/EndingCharge_Wh", BFG.getMatchEndingEnergy()); // PWF Device Management page calls this "Ending depth of discharge"


    // Shown on BFG but cannot get in code:
      // Last match:
